      ...
      <el-form ref="carsRepair_form" label-width=auto :rules="form_rules" :model="request_body" inline>
        ...
        <div style="margin: 50px">
          <el-form-item>
            ...
            <el-button v-if="createStatus" type="primary" @click="addCarsRepair">新增维修记录</el-button>
            <el-button v-if="!createStatus" type="primary" @click="updateCarsRepair">更新维修记录</el-button>
