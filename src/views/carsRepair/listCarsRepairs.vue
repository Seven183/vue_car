  ...
  <div class="app-container">
    ...
    <div class="app-body">
      <el-table :data="list" stripe fit border highlight-current-row>
        ...
        <el-table-column prop="status" label="维修状态" align="center" sortable></el-table-column>
        <el-table-column :label="$t('table.actions')" align="center" min-width="200" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button type="primary" size="mini" style="min-width: 50px;" @click="updateCarsRepair(scope.row)">详情</el-button>
...
<script>
import {deleteCarsRepair, queryAllCarsRepair, selectCarNumbers} from '@/api/carsRepair'
